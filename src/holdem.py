...
class HoldEmHistory(base.History):
    ...
    def is_terminal(self):
        ...
        is_showdown = (
            self.history.count("/") == 3 and self.history[-1] == "c"
    ...
    def actions(self):
        if self.is_chance():
            ...
            for bet_size in range(
                min_bet, remaining_amount + 1
            ):  # These define the legal actions of the game
            ...
            if stage == "preflop":
                ...
                # big blind to act
                    ...
                    ):  # Small blind called, you don't need to fold
                        actions.remove("f")
                        return actions
